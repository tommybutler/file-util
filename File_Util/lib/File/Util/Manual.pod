...
I<that "/" is depth of 1, "/var" is 2 deep, "/var/tmp" is 3 deep, and so on
down through the "/var/tmp" directory.
   ...
   #
   #   ./droids/by-owner/luke/R2.spec | 1024 | 4 deep
   #   ./droids/by-owner/luke/C2P0.spec | 2048 | 4 deep
   #   ./droids/by-boss/dooku/Grievous.spec | 4096 | 4 deep
   #   ./droids/by-series/imperial/sentries/R5.spec | 1024 | 5 deep
   #
   # Depth breakdown
   #
   #    level 1 => ./
   #    level 2 => ./droids/
   #    level 3 => ./droids/by-owner/
   #    level 3 => ./droids/by-boss/
   #    level 3 => ./droids/by-series/
   #    level 4 => ./droids/by-owner/luke/
   #    level 4 => ./droids/by-boss/dooku/
   #    level 4 => ./droids/by-series/imperial/
   #    level 5 => ./droids/by-series/imperial/sentries/
