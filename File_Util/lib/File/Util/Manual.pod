...
call to the constructor.  See L<DIAGNOSTICS|/DIAGNOSTICS> for
the details.
...
will tell the File::Util object whether or not it should enable diagnostic
...
that it will not.  The default setting for C<diagnostic()> is NOT enabled.
