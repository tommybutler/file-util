...
Syntax Examples:
   ...
   $ftl->write_file( {
      ...
      content  => 'Vote for Harvey!  I believe in Harvey Dent!',
      bitmask  => oct 600,  # <-- use secret ballot file permissions
      fatals_as_status => 1 # <-- I'll create my own error message
   } ) or die 'Bane broke my back!';
