...
performance and speed of File::Find in very large file trees.  L<Path::Tiny> is
one such newer utility, but it claims to not suffer from a lack of performance
like the others.
